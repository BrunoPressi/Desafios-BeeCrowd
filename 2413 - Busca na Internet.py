...
João havia lido anteriormente, também na Internet, que o número de pessoas que clicam no segundo link listado
é o dobro de número de pessoas que clicam no terceiro link listado.
...
# N de pessoas que clicam no segundo link == 2 * N de pessoas que clicam no terceiro link.
# N de pessoas que clicam no segundo link é a metade das pessoas que clicam no primeiro link.

terceiroLink = int(input("")) # N de pessoas que clicaram no terceiro link.

if 1 <= terceiroLink <= 1000:
